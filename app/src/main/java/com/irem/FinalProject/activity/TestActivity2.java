...
import com.irem.FinalProject.utils.QuestionsItem;
...
public class TestActivity2 extends AppCompatActivity {
        ...
        aans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentQuestions < questionsItems.size()-1) {
                    ...
                    Intent intent = new Intent(TestActivity2.this, ResultActivity2.class);
    ...
    private void loadAllQuestions() {
        ...
        String jsonstr = loadJsonFromAsset("worldwar2questions.json");
        try {
            JSONObject jsonObject = new JSONObject(jsonstr);
            JSONArray questions = jsonObject.getJSONArray("worldwar2questions");
    ...
    public void onBackPressed() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(TestActivity2.this, R.style.Theme_Transparent);
        ...
        diaYes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent cnn = new Intent( TestActivity2.this, MainActivity2.class );
                startActivity( cnn );
                finish();
            }
        });
